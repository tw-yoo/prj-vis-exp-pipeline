...
2. **3-Module LLM 파이프라인 실행**
   - Module 1: Decompose (goal-driven plan)
   - Module 2: Ground (roles/values를 chart_context 기반으로 확정)
   - Module 3: Compile (plan → 최종 OpsSpec groups)
...
실행 orchestrator:
- `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/pipeline.py`

### 4.0 Deterministic Context Builder
- 파일: `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/context_builder.py`
- 역할:
  - Vega-Lite encoding의 `type`(nominal/quantitative/temporal 등)을 강한 힌트로 사용해 field type/role을 안정화
  - `ChartContext` 생성

### Module 1: Decompose (Question+Explanation → PlanTree)
- 파일: `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/module_decompose.py`
- 프롬프트: `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/prompts/opsspec_decompose.md`
- 출력: `plan_tree.nodes[]` (flat params, nodeId=n<digits>, inputs=nodeId only)

PlanTree 검증:
- `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/plan_validators.py`
- 과생성 방지, 구조 제약, question intent 정합 검증 포함

### Module 2: Ground (PlanTree → GroundedPlanTree)
- 파일: `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/module_ground.py`
- 프롬프트: `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/prompts/opsspec_ground.md`
- 역할:
  - `@primary_measure/@primary_dimension/@series_field` token을 실제 field로 치환
  - series 값이면 `group="<value>"`로 제한(필터로 series_field를 직접 필터링하지 않음)

### Module 3: Compile (GroundedPlanTree → OpsSpec Group Map)
- 파일: `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/module_compile.py`
- 프롬프트: `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/prompts/opsspec_compile.md`
- 역할:
  - 최종 operation spec을 op별 모델(Discriminated Union)로 맞춰 출력
  - `ref:nX` 참조 규칙 준수

Ops contract(LLM에 주입되는 op별 required/optional/forbidden):
- `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/op_registry.py`
...
semantic validator:
- `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/validators.py`
...
canonicalizer:
- `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/canonicalize.py`
...
- `02_module1_decompose.json`, `03_module2_ground.json`, `04_module3_compile.json`
- `05_final_grammar.json`
- `06_tree_ops_spec.dot` (+ Graphviz 있으면 `.svg`/`.png`)
...
LLM client:
- `/Users/taewon_1/Desktop/vis-exp/explainable_chart_qa/prj-vis-exp/prj-vis-exp/nlp_server/opsspec/llm.py`
